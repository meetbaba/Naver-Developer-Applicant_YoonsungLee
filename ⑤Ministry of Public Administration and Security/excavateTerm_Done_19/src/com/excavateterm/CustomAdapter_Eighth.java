...
public class CustomAdapter_Eighth extends BaseAdapter {
     
	private static final String TAG="CustomAdapter_Sixth";

    // 문자열을 보관 할 ArrayList
    private ArrayList<ItemContent>   m_List;
    private int m_currentItem=0; 
    // 생성자
    public CustomAdapter_Eighth() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( convertView == null ) {
            ...
            convertView = inflater.inflate(R.layout.item_eighth, parent, false);
             
            text    = (TextView) convertView.findViewById(R.id.eighth_custom_item_textview);
    	...
    	if(tmpItem.getStatus()==StaticStrings.STATUS_PRE){
        	text.setBackgroundResource(R.drawable.eighth_choice_textview_pre);
        }else if(tmpItem.getStatus()==StaticStrings.STATUS_CHOICE){
        	text.setBackgroundResource(R.drawable.eighth_choice_textview_choice);
        }
...
public class CustomOnClickListener implements OnClickListener {
    ...
    public void onClick(View v) {
    	...
    	for(int i=0; i<getCount(); i++){
    		m_List.get(i).setStatus(StaticStrings.STATUS_PRE);
    	}
    	...
    	flag=StaticStrings.FLAG_EIGHT_CLICK;
