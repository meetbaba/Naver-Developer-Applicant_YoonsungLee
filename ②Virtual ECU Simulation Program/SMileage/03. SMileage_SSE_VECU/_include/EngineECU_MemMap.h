...
#elif defined(EngineECU_START_SEC_CODE)
#undef EngineECU_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(EngineECU_STOP_SEC_CODE)
#undef EngineECU_STOP_SEC_CODE
