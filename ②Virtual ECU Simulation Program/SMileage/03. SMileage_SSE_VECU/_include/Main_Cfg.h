/** \file         Main_Cfg.h
  *
  * \brief        General settings (BSW, XCP) for RTPC-EVE ( target platform: VRTA-ux/RTPC )
  *
  * [$crn:2007:dox
  ...
  *
  * $Id: Main_Cfg.h 2379 2012-08-10 12:55:57Z pin9fe $
  */
...
/* If defined, XCP support will be activated and your OS
 * configuration must contain a cyclic task named "XCPTask".
 */
#define ENABLE_XCP
...
/* Name of the ComM User defined in the BSW */
#define VECU_COMMUSER ComMUser_0
