...
#elif defined(FuelCutAlgo_START_SEC_CODE)
#undef FuelCutAlgo_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(FuelCutAlgo_STOP_SEC_CODE)
#undef FuelCutAlgo_STOP_SEC_CODE
